 ...
 * XLogHelper.decorateElement(e11, "org:group", "Department 1", "Organizational"); // with "Organizational" extension
 * </pre>
 * 
...
public class XLogHelper {
	...
	/**
	 * This method generates a new {@link XLog} and returns it. By default, some of
	 * the standard extensions are registered, specifically:
	 * <ul>
	...
	/**
	 * This method creates a new {@link XTrace} with the given case id, and returns
	 * the new trace
	 * 
	...
	/**
	 * This method creates a new {@link XTrace} with the given case id, adds it to
	 * the given log object, and returns the new trace
	 * 
	 ...
	 * name, occurred at the given time. The event is added to the given trace, and
	 * returned
	 * 
	 * @param trace        the trace that is going to host the new event
	 * @param activityName the name of the activity the new event is going to refer
	 *                     to
	 * @param timestamp    the time the new event occurred
	 * @return the new event created, or <tt>null</tt> if the given trace is not
	 *         valid
	 */
	...
	/**
	 * This method can be used to decorate an {@link XAttributable} element (such as
	 * {@link XLog}, {@link XTrace}, and {@link XEvent}) with a string value
	 * 
	...
	public static void decorateElement(XAttributable element, String attributeName, String value,
		...
		XAttributeLiteral attribute = xesFactory.createAttributeLiteral(attributeName, value,
				xesExtensionManager.getByName(extensionName));
	...
	/**
	 * This method can be used to decorate an {@link XAttributable} element (such as
	 * {@link XLog}, {@link XTrace}, and {@link XEvent}) with a double value
	 * 
	 * @param element       the element to decorate
	 * @param attributeName the attribute name
	 * @param value         the attribute value
	...
	public static void decorateElement(XAttributable element, String attributeName, Double value,
		...
		XAttributeContinuous attribute = xesFactory.createAttributeContinuous(attributeName, value,
				xesExtensionManager.getByName(extensionName));
		XAttributeMap attributes = element.getAttributes();
		if (attributes == null || attributes.isEmpty()) {
			attributes = xesFactory.createAttributeMap();
	...
	/**
	 * This method can be used to decorate an {@link XAttributable} element (such as
	 * {@link XLog}, {@link XTrace}, and {@link XEvent}) with a date value
	 * 
	 * @param element       the element to decorate
	 * @param attributeName the attribute name
	 * @param value         the attribute value
	...
	public static void decorateElement(XAttributable element, String attributeName, Date value, String extensionName) {
		...
		XAttributeTimestamp attribute = xesFactory.createAttributeTimestamp(attributeName, value,
				xesExtensionManager.getByName(extensionName));
		XAttributeMap attributes = element.getAttributes();
		if (attributes == null) {
			attributes = xesFactory.createAttributeMap();
	...
	/**
	 * This method can be used to decorate an {@link XAttributable} element (such as
	 * {@link XLog}, {@link XTrace}, and {@link XEvent}) with a boolean value
	 * 
	 * @param element       the element to decorate
	 * @param attributeName the attribute name
	 * @param value         the attribute value
	...
	public static void decorateElement(XAttributable element, String attributeName, Boolean value,
		...
		XAttributeBoolean attribute = xesFactory.createAttributeBoolean(attributeName, value,
				xesExtensionManager.getByName(extensionName));
		XAttributeMap attributes = element.getAttributes();
		if (attributes == null) {
			attributes = xesFactory.createAttributeMap();
	...
	/**
	 * This method can be used to decorate an {@link XAttributable} element (such as
	 * {@link XLog}, {@link XTrace}, and {@link XEvent}) with a long value
	 * 
	 * @param element       the element to decorate
	 * @param attributeName the attribute name
	 * @param value         the attribute value
	...
	public static void decorateElement(XAttributable element, String attributeName, Long value, String extensionName) {
		...
		XAttributeDiscrete attribute = xesFactory.createAttributeDiscrete(attributeName, value,
				xesExtensionManager.getByName(extensionName));
		XAttributeMap attributes = element.getAttributes();
		if (attributes == null) {
			attributes = xesFactory.createAttributeMap();
	...
	/**
	 * This method can be used to decorate an {@link XAttributable} element (such as
	 * {@link XLog}, {@link XTrace}, and {@link XEvent}) with an integer value
	 * 
	 * @param element       the element to decorate
	 * @param attributeName the attribute name
	 * @param value         the attribute value
	...
	/**
	 * This method returns the value of the attribute <tt>concept:name</tt> for the
	 * given attributable element
	 * 
	...
	/**
	 * This method returns the value of the attribute <tt>time:timestamp</tt> for
	...
	/**
	 * This method sets the value of the attribute <tt>time:timestamp</tt> for the
	 * given attributable element
	 * 
	...
	/**
	 * This method sorts the given trace according to the timestamps of its events
	 * 
	...
	/**
	 * This method converts a trace into a list of traces each of them containing
	 * only one event. The order of the returned list is the same of the events in
	 * the original trace.
	 * 
	...
	public static XLog readFile(String fileName) throws Exception {
		XesXmlParser xesParserXml = new XesXmlParser();
		XesXmlGZIPParser xesParserGzip = new XesXmlGZIPParser();

		File file = new File(fileName);

		if (xesParserXml.canParse(file)) {
			return xesParserXml.parse(file).get(0);
		} else if (xesParserGzip.canParse(file)) {
			return xesParserGzip.parse(file).get(0);
		}
		return null;
	}
}